...
def bayesianmain(filepath=None,K=5):
	...
	plt.savefig('sih/static/AIS_lat_goodbad.png')
	...
	plt.savefig('sih/static/AIS_long_goodbad.png')
	...
	plt.savefig('sih/static/Distribution_all_ships_lat_only.png')	
	...
	plt.ylabel('Frequency')
	plt.savefig('sih/static/Distribution_all_ships_long_only.png')